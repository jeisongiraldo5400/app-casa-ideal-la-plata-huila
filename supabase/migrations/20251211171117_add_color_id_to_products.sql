-- ============================================================================
-- Agregar campo color_id a la tabla products
-- ============================================================================

-- Agregar columna color_id a la tabla products
ALTER TABLE public.products 
    ADD COLUMN IF NOT EXISTS color_id UUID NULL;
...
CREATE INDEX IF NOT EXISTS idx_products_color_id 
    ON public.products(color_id)
    WHERE color_id IS NOT NULL;

-- Comentario en la columna
COMMENT ON COLUMN public.products.color_id IS 
    'Referencia al color del producto. NULL si el producto no tiene color asignado.';

-- ============================================================================
-- Actualizar función RPC: get_products_dashboard
-- Agregar color_id y color_name a la respuesta
-- ============================================================================
...
-- Crear la función con el nuevo tipo de retorno que incluye color_id y color_name
...
COMMENT ON FUNCTION public.get_products_dashboard(text, integer, integer) IS
    'Devuelve productos con marca/categoría/color y stock agregado. Incluye búsqueda, paginación y total_count.';
