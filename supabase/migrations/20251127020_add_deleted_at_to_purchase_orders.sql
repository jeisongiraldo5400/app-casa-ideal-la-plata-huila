-- ============================================================================
-- Agregar campo deleted_at a purchase_orders para soft delete
-- ============================================================================
...
-- Crear índice parcial para optimizar consultas de órdenes activas
CREATE INDEX IF NOT EXISTS idx_purchase_orders_deleted_at 
    ON public.purchase_orders(deleted_at) 
    WHERE deleted_at IS NULL;

-- Comentario en la columna
COMMENT ON COLUMN public.purchase_orders.deleted_at IS 
    'Fecha de eliminación lógica. NULL significa que la orden está activa.';

-- ============================================================================
-- Actualizar función RPC: get_purchase_orders_dashboard
-- ============================================================================
...
COMMENT ON FUNCTION public.get_purchase_orders_dashboard(text, integer, integer) IS
    'Devuelve órdenes de compra activas (deleted_at IS NULL) con proveedor, items, estado de completitud y total_count.';

-- ============================================================================
-- Actualizar función RPC: get_purchase_orders_stats
-- ============================================================================
...
COMMENT ON FUNCTION public.get_purchase_orders_stats() IS
    'Calcula estadísticas globales de órdenes de compra activas (deleted_at IS NULL) en una sola consulta.';
