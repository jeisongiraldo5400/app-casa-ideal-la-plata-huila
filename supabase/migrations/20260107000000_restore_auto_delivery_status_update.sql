-- ============================================================================
-- Migration: Restore automatic status update to 'delivered' on delivery completion
-- Date: 2026-01-07
-- Description: Modifies update_delivery_order_progress to automatically change order status
--              to 'delivered' when all items are delivered. Only updates status if current
--              status is 'pending', 'approved', or 'sent_by_remission'.
-- ============================================================================
