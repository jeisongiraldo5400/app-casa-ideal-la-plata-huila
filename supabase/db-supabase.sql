...
CREATE OR REPLACE FUNCTION "public"."get_products_dashboard"("search_term" "text" DEFAULT ''::"text", "page" integer DEFAULT 1, "page_size" integer DEFAULT 5, "include_deleted" boolean DEFAULT false) RETURNS TABLE("id" "uuid", "name" "text", "sku" "text", "barcode" "text", "status" boolean, "created_at" timestamp with time zone, "deleted_at" timestamp with time zone, "brand_id" "uuid", "brand_name" "text", "category_id" "uuid", "category_name" "text", "color_id" "uuid", "color_name" "text", "total_stock" numeric, "stock_by_warehouse" "jsonb", "total_count" bigint)
    LANGUAGE "plpgsql" STABLE
    AS $$
DECLARE
    _limit           integer := GREATEST(COALESCE(page_size, 5), 1);
...
ALTER FUNCTION "public"."get_products_dashboard"("search_term" "text", "page" integer, "page_size" integer, "include_deleted" boolean) OWNER TO "postgres";


COMMENT ON FUNCTION "public"."get_products_dashboard"("search_term" "text", "page" integer, "page_size" integer, "include_deleted" boolean) IS 'Devuelve productos con marca/categoría/color y stock agregado. include_deleted=true incluye productos con deleted_at IS NOT NULL. Solo incluye bodegas con stock > 0.';
...
GRANT ALL ON FUNCTION "public"."get_products_dashboard"("search_term" "text", "page" integer, "page_size" integer, "include_deleted" boolean) TO "anon";
GRANT ALL ON FUNCTION "public"."get_products_dashboard"("search_term" "text", "page" integer, "page_size" integer, "include_deleted" boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_products_dashboard"("search_term" "text", "page" integer, "page_size" integer, "include_deleted" boolean) TO "service_role";
