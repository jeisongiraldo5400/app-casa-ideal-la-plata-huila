import type { ExitSerial, ExitSerialCaptureMethod } from '@/components/exits/infrastructure/services/exitSerials';
...
interface ExitSerialsFieldProps {
  serials: ExitSerial[];
  ...
  onAdd: (raw: string, method: ExitSerialCaptureMethod) => Promise<boolean>;
  onRemove: (index: number) => void;
  onScanPress: () => void;
}

/** Captura opcional del serial de fábrica de cada unidad que sale. */
export function ExitSerialsField({ serials, quantity, checking, error, onAdd, onRemove, onScanPress }: ExitSerialsFieldProps) {
  ...
  return (
    <View style={styles.section}>
      ...
      <Text style={[styles.hint, { color: colors.text.secondary }]}>
        Escanea o escribe el serial de cada aparato. Un serial que ya salió no se puede volver a despachar.
      </Text>
