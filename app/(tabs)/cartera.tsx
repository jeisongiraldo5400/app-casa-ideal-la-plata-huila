...
function CarteraScreenInner() {
  ...
  return <View style={[styles.container,{backgroundColor:colors.background.default}]}> 
    ...
    <CarteraFilterModal visible={filtersOpen} municipios={municipios} sellers={sellers} paymentMethods={paymentMethods} values={draftFilters} onChange={setDraftFilters} onClose={applyFilters}/>
