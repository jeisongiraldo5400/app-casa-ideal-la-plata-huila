...
const styles=StyleSheet.create({container:{flex:1},list:{padding:Spacing.xl,paddingBottom:Spacing.xxxl},top:{flexDirection:'row',justifyContent:'space-between',alignItems:'center',marginBottom:Spacing.lg},title:{fontSize:28,lineHeight:34,fontWeight:'800'},actions:{flexDirection:'row',gap:Spacing.sm},icon:{width:46,height:46,alignItems:'center',justifyContent:'center',borderRadius:Radius.control},cards:{flexDirection:'row',flexWrap:'wrap',gap:Spacing.md,marginBottom:Spacing.md},card:{width:'48%',minHeight:82,borderWidth:1,borderRadius:Radius.card,padding:Spacing.md,gap:4,...Shadows.card},managerButton:{minHeight:52,borderWidth:1,borderRadius:Radius.control,padding:Spacing.md,flexDirection:'row',alignItems:'center',gap:9,marginBottom:Spacing.md},section:{fontSize:19,lineHeight:24,fontWeight:'800',marginTop:Spacing.sm},row:{flexDirection:'row',padding:Spacing.lg,borderRadius:Radius.card,borderLeftWidth:4,marginBottom:Spacing.md,gap:Spacing.sm,...Shadows.card},empty:{textAlign:'center',marginVertical:35},loadMore:{minHeight:50,borderWidth:1,borderRadius:Radius.control,padding:Spacing.md,alignItems:'center',marginTop:Spacing.sm},end:{textAlign:'center',marginVertical:Spacing.lg,fontSize:12},pickerRoot:{flex:1},pickerHeader:{padding:Spacing.lg,flexDirection:'row',justifyContent:'space-between',borderBottomWidth:1},managerSearch:{margin:Spacing.lg,borderWidth:1,borderRadius:Radius.control,padding:Spacing.md},managerRow:{padding:Spacing.lg,flexDirection:'row',gap:10,alignItems:'center',borderBottomWidth:1}});
